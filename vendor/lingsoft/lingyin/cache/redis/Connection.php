...
use lingyin\base\exception\InvalidMethodException;

/**
 * Class Connection
 * @package lingyin\cache\redis
 */
abstract class Connection
{
    ...
    public function __call($name, $params)
    {
        ...
        if (in_array($redisCommand, $this->commandList)) {
            return $this->executeCommand($redisCommand, $params);
        }

        throw new InvalidMethodException("方法{$name}不存在");
    }

    abstract function executeCommand($name, $params = []);
